        ...
        this.router.post(this.basePath + paths.LOGIN_USER, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, ApiRestLoginValidationHandler_1.default.login(req)];
                    case 1:
                        login = _a.sent();
                        return [4 /*yield*/, ApiRestLoginController_1.default.signIn(login)];
                    case 2:
                        dataOut = _a.sent();
                        //[3] Send response
                        ApiRestResponseHandler_1.default.respond(res, dataOut);
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _a.sent();
